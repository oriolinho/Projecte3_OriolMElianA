...
public class ChatServer extends Application {
	...
	public void start(Stage servidorStage) throws Exception {
		//crear fil pel server , i és crida la classe d'Inicar chat on és genera el socket per al server
		Thread startServer = new Thread(new IniciarChat());
		startServer.start();
		enviar.setLayoutX(50);
		enviar.setLayoutY(630);
		enviar.setStyle("-fx-base: #CEECEE;");
		...
		desencriptar.setLayoutY(630);
		desencriptar.setStyle("-fx-base: #CEECEE");
